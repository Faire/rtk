...
## [1.0.0](https://github.com/Faire/rtk/compare/v0.30.0...v1.0.0) (2026-03-19)
...
* `rtk rewrite` — single source of truth for LLM hook rewrites ([#241](https://github.com/Faire/rtk/issues/241)) ([f447a3d](https://github.com/Faire/rtk/commit/f447a3d5b136dd5b1df3d5cc4969e29a68ba3f89))
* add --quota flag to rtk gain with tier-based analysis ([26b314d](https://github.com/Faire/rtk/commit/26b314d45b8b0a0c5c39fb0c17001ecbde9d97aa))
* add -A flag to kubectl pods/services for all namespaces ([06816b3](https://github.com/Faire/rtk/commit/06816b36859ab0ac0698ae56d7fa9598557d07ff))
* add /repo-recap skill for PR/issue/release summaries ([981d3be](https://github.com/Faire/rtk/commit/981d3be7db434af1e574ba100148b87e45f62d84))
* add `rtk wc` command for compact word/line/byte counts ([#175](https://github.com/Faire/rtk/issues/175)) ([393fa5b](https://github.com/Faire/rtk/commit/393fa5ba2bda0eb1f8655a34084ea4c1e08070ae))
* add 11 new TOML built-in filters (xcodebuild, jq, basedpyright, ty, skopeo, stat, biome, oxlint, jj, ssh, gcc) ([#490](https://github.com/Faire/rtk/issues/490)) ([e5e2f87](https://github.com/Faire/rtk/commit/e5e2f8760679a01388235efd3f43a0a0ae82f1f6))
* add 32 TOML-filtered commands to hook rewrite rules ([#475](https://github.com/Faire/rtk/issues/475)) ([91289d7](https://github.com/Faire/rtk/commit/91289d761b289c4f85556db4c667bf1d8ebe6ce5))
* add AWS CLI and psql modules with token-optimized output ([#216](https://github.com/Faire/rtk/issues/216)) ([b934466](https://github.com/Faire/rtk/commit/b934466364c131de2656eefabe933965f8424e18))
* add chaining instructions to init command ([97ed27a](https://github.com/Faire/rtk/commit/97ed27ad127a0a282ede611a2207fb6f431e113e))
* add CI/CD automation (release management and automated metrics) ([22c3017](https://github.com/Faire/rtk/commit/22c3017ed5d20e5fb6531cfd7aea5e12257e3da9))
* add Claude Code skills for PR and issue triage ([#343](https://github.com/Faire/rtk/issues/343)) ([6ad6ffe](https://github.com/Faire/rtk/commit/6ad6ffeccee9b622013f8e1357b6ca4c94aacb59))
* add comprehensive claude code economics analysis ([ec1cf9a](https://github.com/Faire/rtk/commit/ec1cf9a56dd52565516823f55f99a205cfc04558))
* add comprehensive security review workflow for PRs ([1ca6e81](https://github.com/Faire/rtk/commit/1ca6e81bdf16a7eab503d52b342846c3519d89ff))
* add comprehensive security review workflow for PRs ([66101eb](https://github.com/Faire/rtk/commit/66101ebb65076359a1530d8f19e11a17c268bce2))
* add comprehensive temporal audit system for token savings analytics ([76703ca](https://github.com/Faire/rtk/commit/76703ca3f5d73d3345c2ed26e4de86e6df815aff))
* add discover command, auto-rewrite hook, and git show support ([ff1c759](https://github.com/Faire/rtk/commit/ff1c7598c240ca69ab51f507fe45d99d339152a0))
* add execution time tracking to rtk gain analytics ([a3bfbf7](https://github.com/Faire/rtk/commit/a3bfbf747c00979636f9bbe82d973b6ab43dfbca))
* add execution time tracking to rtk gain analytics ([2a1e1a8](https://github.com/Faire/rtk/commit/2a1e1a8ef3afb97080e9e51d7927ea3b5199ddc7))
* add GitHub CLI integration (depends on [#9](https://github.com/Faire/rtk/issues/9)) ([341c485](https://github.com/Faire/rtk/commit/341c48520792f81889543a5dc72e572976856bbb))
* add GitHub CLI integration with token optimizations ([0f7418e](https://github.com/Faire/rtk/commit/0f7418e958b23154cb9dcf52089a64013a666972))
* add hook audit mode for verifiable rewrite metrics ([#151](https://github.com/Faire/rtk/issues/151)) ([70c3786](https://github.com/Faire/rtk/commit/70c37867e7282ee0ccf200022ecef8c6e4ab52f4))
* add JSON parsing with safe fallbacks for vitest, playwright, pnpm ([50ba21e](https://github.com/Faire/rtk/commit/50ba21e2e5fcc2ad5a5f3792f323900d9d5dffe4))
* add local LLM analysis, filter improvements, and testing scripts ([1d85791](https://github.com/Faire/rtk/commit/1d857914d61d569028e3b7b5a90b287fa5260f9f))
* add modern JavaScript tooling support ([b82fa85](https://github.com/Faire/rtk/commit/b82fa85ae5fe0cc1f17d8acab8c6873f436a4d62))
* add modern JavaScript tooling support (lint, tsc, next, prettier, playwright, prisma) ([88c0174](https://github.com/Faire/rtk/commit/88c0174d32e0603f6c5dcc7f969fa8f988573ec6))
* add Modern JS Stack commands to benchmark script ([b868987](https://github.com/Faire/rtk/commit/b868987f6f48876bb2ce9a11c9cad12725401916))
* add mypy command with grouped error output ([#109](https://github.com/Faire/rtk/issues/109)) ([e8ef341](https://github.com/Faire/rtk/commit/e8ef3418537247043808dc3c88bfd189b717a0a1))
* add OpenCode plugin support ([#300](https://github.com/Faire/rtk/issues/300)) ([064cb3e](https://github.com/Faire/rtk/commit/064cb3ea65fd499ac0d58c2e76004f06ca1a6e1e))
* add parser infrastructure with three-tier fallback system ([6493bc9](https://github.com/Faire/rtk/commit/6493bc92d8c4155cd3b2a5f39fdae846fee2ca81))
* add parser infrastructure with three-tier fallback system ([edab4e1](https://github.com/Faire/rtk/commit/edab4e142eecd81682006ad44c39809e7aae9011))
* add pnpm support (list, outdated, install) ([681729d](https://github.com/Faire/rtk/commit/681729d205705dd7d5e75530486c48abc4aa3d5e))
* add pnpm support + fix git argument parsing for modern stacks ([e574b6d](https://github.com/Faire/rtk/commit/e574b6df3acf2b7eb8dfcb4ba34c3541a42b11ee))
* add Python and Go support ([#88](https://github.com/Faire/rtk/issues/88)) ([30a30ee](https://github.com/Faire/rtk/commit/30a30eefd98396849e0235bd42e293f10c23e500))
* add Python and Go support ([#88](https://github.com/Faire/rtk/issues/88)) ([a005bb1](https://github.com/Faire/rtk/commit/a005bb15c030e16b7b87062317bddf50e12c6f32))
* add quota analysis with multi-tier support ([64c0b03](https://github.com/Faire/rtk/commit/64c0b03d4e4e75a7051eac95be2d562797f1a48a))
* add rtk session command for adoption overview ([be67d66](https://github.com/Faire/rtk/commit/be67d660100c06a0751c08d943dc884ad5bff6a3))
* add rtk session command for adoption overview ([12d44c4](https://github.com/Faire/rtk/commit/12d44c4068d7d4f65d5bd7551af29ab5a2352ed1)), closes [#487](https://github.com/Faire/rtk/issues/487)
* add rtk tree + fix rtk ls + audit phase 1-2 ([278cc57](https://github.com/Faire/rtk/commit/278cc5700bc39770841d157f9c53161f8d62df1e))
* add shared utils module for JS stack commands ([0fc06f9](https://github.com/Faire/rtk/commit/0fc06f95098e00addf06fe71665638ab2beb1aac))
* add SQLite tracking, gain command, and CI/CD ([f8c9a81](https://github.com/Faire/rtk/commit/f8c9a8165f6f2fcc2f9046aa10d27cd85d001f8b))
* add structured dotnet support (build/test/restore/format) ([a8dbe33](https://github.com/Faire/rtk/commit/a8dbe33b84320207323c738d76d6ef3dbb470298))
* add wget command for compact download output ([26796da](https://github.com/Faire/rtk/commit/26796da96a5d1d7d9ad73960957804ff8110d299))
* add worktree slash commands for isolated development ([#364](https://github.com/Faire/rtk/issues/364)) ([ab83e79](https://github.com/Faire/rtk/commit/ab83e7933ebc26ca76f843d33285729875efb913))
* anonymous telemetry ping (1/day, opt-out) ([#334](https://github.com/Faire/rtk/issues/334)) ([baff6a2](https://github.com/Faire/rtk/commit/baff6a2334b155c0d68f38dba85bd8d6fe9e20af))
* audit phase 3 + tracking validation + rtk learn ([7975624](https://github.com/Faire/rtk/commit/7975624d0a83c44dfeb073e17fd07dbc62dc8329))
* cargo build/test/clippy with compact output ([bfd5646](https://github.com/Faire/rtk/commit/bfd5646f4eac32b46dbec05f923352a3e50c19ef))
* **cargo:** add `cargo install` filtering with 80-90% token reduction ([645a773](https://github.com/Faire/rtk/commit/645a773a65bb57dc2635aa405a6e2b87534491e3)), closes [#69](https://github.com/Faire/rtk/issues/69)
* **cargo:** add cargo install filtering ([447002f](https://github.com/Faire/rtk/commit/447002f8ba3bbd2b398f85db19b50982df817a02))
* **cargo:** add cargo nextest support with failures-only output ([#107](https://github.com/Faire/rtk/issues/107)) ([68fd570](https://github.com/Faire/rtk/commit/68fd570f2b7d5aaae7b37b07eb24eae21542595e))
* **cargo:** aggregate test output into single line ([#83](https://github.com/Faire/rtk/issues/83)) ([3806c4b](https://github.com/Faire/rtk/commit/3806c4b4234eeb66bdaf2dc5639fbe9cea23d392))
* **cargo:** aggregate test output into single line ([#83](https://github.com/Faire/rtk/issues/83)) ([#85](https://github.com/Faire/rtk/issues/85)) ([06b1049](https://github.com/Faire/rtk/commit/06b10491f926f9eca4323c80d00530a1598ec649))
* CI/CD automation (versioning, benchmarks, README auto-update) ([b8bbfb8](https://github.com/Faire/rtk/commit/b8bbfb87b4dc2b664f64ee3b0231e346a2244055))
* **ci:** automate Homebrew formula update on release ([#80](https://github.com/Faire/rtk/issues/80)) ([a0d2184](https://github.com/Faire/rtk/commit/a0d2184bfef4d0a05225df5a83eedba3c35865b3))
* Claude Code tooling — 2 agents, 7 commands, 2 rules, 4 skills ([#491](https://github.com/Faire/rtk/issues/491)) ([7b7a5ae](https://github.com/Faire/rtk/commit/7b7a5ae4b6d23fbb882ed7d5e815e2ed0672c46c))
* comprehensive economics analysis and code quality improvements ([8e72e7a](https://github.com/Faire/rtk/commit/8e72e7a8b8ac7e94e9b13958d8b6b8e9bf630660))
* Comprehensive Temporal Audit System for Token Savings Analytics ([862047e](https://github.com/Faire/rtk/commit/862047e387e95b137973983b4ebad810fe5b4431))
* **config:** repo-level .rtk.toml support ([#12](https://github.com/Faire/rtk/issues/12)) ([d8481c1](https://github.com/Faire/rtk/commit/d8481c11a67f4468c2123aa379f31d75378858f7))
* curl with auto-JSON detection ([314accb](https://github.com/Faire/rtk/commit/314accbfd9ac82cc050155c6c47dfb76acab14ce))
* discover command, auto-rewrite hook, git show ([c9c64cf](https://github.com/Faire/rtk/commit/c9c64cfd30e2c867ce1df4be508415635d20132d))
* **docker:** add docker compose support ([#110](https://github.com/Faire/rtk/issues/110)) ([510c491](https://github.com/Faire/rtk/commit/510c491238731b71b58923a0f20443ade6df5ae7))
* **gain:** add per-project token savings with -p flag ([#128](https://github.com/Faire/rtk/issues/128)) ([2b550ee](https://github.com/Faire/rtk/commit/2b550eebd6219a4844488d8fde1842ba3c6dec25))
* **gain:** colored dashboard with efficiency meter and impact bars ([#129](https://github.com/Faire/rtk/issues/129)) ([606b86e](https://github.com/Faire/rtk/commit/606b86ed43902dc894e6f1711f6fe7debedc2530))
* gh pr create/merge/diff/comment/edit + gh api ([517a93d](https://github.com/Faire/rtk/commit/517a93d0e4497414efe7486410c72afdad5f8a26))
* git branch, fetch, stash, worktree commands ([bc31da8](https://github.com/Faire/rtk/commit/bc31da8ad9d9e91eee8af8020e5bd7008da95dd2))
* **git:** add fallback passthrough for unsupported subcommands ([32bbd02](https://github.com/Faire/rtk/commit/32bbd025345872e46f67e8c999ecc6f71891856b))
* **gradle:** batch filter + fix duplicate output ([#16](https://github.com/Faire/rtk/issues/16)) ([161459b](https://github.com/Faire/rtk/commit/161459b336215ab81dc24f66a3256032a2f81a67))
* **gradle:** COMPILE filter + path normalization ([#3](https://github.com/Faire/rtk/issues/3)) ([d2efd00](https://github.com/Faire/rtk/commit/d2efd00d8eed8cb9b00f925213798d407feb4a73))
* **gradle:** DEPS filter — dependency tree depth truncation ([#8](https://github.com/Faire/rtk/issues/8)) ([627a8d8](https://github.com/Faire/rtk/commit/627a8d817eef46b2de3ba84aaa36fb30df961552))
* **gradle:** DETEKT filter with violation grouping ([#5](https://github.com/Faire/rtk/issues/5)) ([dc9208a](https://github.com/Faire/rtk/commit/dc9208affad0aad003377fd30ab00379e5abcecc))
* **gradle:** global noise line filters + config ([#2](https://github.com/Faire/rtk/issues/2)) ([74669d3](https://github.com/Faire/rtk/commit/74669d335793eaaeac44669b558379df5fb09598))
* **gradle:** HEALTH + PROTO filters ([#9](https://github.com/Faire/rtk/issues/9)) ([c5f9f3a](https://github.com/Faire/rtk/commit/c5f9f3a10853036716f29368fda1859798c0cc8b))
* **gradle:** multi-task batch filter ([#10](https://github.com/Faire/rtk/issues/10)) ([a95fd32](https://github.com/Faire/rtk/commit/a95fd32f0d78c9e1baf25610a2c239ecdaebb5c0))
* **gradle:** scaffold module + command wiring + hooks ([#1](https://github.com/Faire/rtk/issues/1)) ([af5205d](https://github.com/Faire/rtk/commit/af5205d48c9982c2f51401b9f399b4dfd0e79edd))
* **gradle:** TEST filter + stack trace truncation ([#4](https://github.com/Faire/rtk/issues/4)) ([fa8f2b7](https://github.com/Faire/rtk/commit/fa8f2b72a6565749cc2d1bee645746b0a3adb0f8))
* **grep:** add extra args passthrough (-i, -A/-B/-C, etc.) ([a240d1a](https://github.com/Faire/rtk/commit/a240d1a1ee0d94c178d0c54b411eded6c7839599))
* **gt:** add Graphite CLI support ([#290](https://github.com/Faire/rtk/issues/290)) ([7fbc4ef](https://github.com/Faire/rtk/commit/7fbc4ef4b553d5e61feeb6e73d8f6a96b6df3dd9))
* Hook-first installation with 99.5% token reduction ([e7f80ad](https://github.com/Faire/rtk/commit/e7f80ad29481393d16d19f55b3c2171a4b8b7915))
* **hook:** handle global options before subcommands ([#99](https://github.com/Faire/rtk/issues/99)) ([7401f10](https://github.com/Faire/rtk/commit/7401f1099f3ef14598f11947262756e3f19fce8f))
* **init:** auto-patch settings.json for frictionless hook installation ([2db7197](https://github.com/Faire/rtk/commit/2db7197e020857c02857c8ef836279c3fd660baf))
* **init:** auto-patch settings.json for frictionless hook installation ([848a63d](https://github.com/Faire/rtk/commit/848a63dfac5516308bf8050cbb94408b752e8997))
* **init:** refactor to hook-first with slim RTK.md ([9620f66](https://github.com/Faire/rtk/commit/9620f66cd64c299426958d4d3d65bd8d1a9bc92d))
* make install-local.sh self-contained ([#89](https://github.com/Faire/rtk/issues/89)) ([6bcdb3e](https://github.com/Faire/rtk/commit/6bcdb3e5863c064e283d77cff0d337281eb59baa))
* make install-local.sh self-contained ([#89](https://github.com/Faire/rtk/issues/89)) ([b82ad16](https://github.com/Faire/rtk/commit/b82ad168533881757f45e28826cb0c4bd4cc6f97))
* migrate vitest, playwright, pnpm to OutputParser trait ([cf26ad4](https://github.com/Faire/rtk/commit/cf26ad477bdbff448d7eb06725c86cf2805dcdef))
* npm/npx routing, pnpm build/typecheck, --skip-env flag ([49b3cf2](https://github.com/Faire/rtk/commit/49b3cf293d856ff3001c46cff8fee9de9ef501c5))
* passthrough fallback when Clap parse fails + review fixes ([#200](https://github.com/Faire/rtk/issues/200)) ([772b501](https://github.com/Faire/rtk/commit/772b5012ede833c3f156816f212d469560449a30))
* **pnpm:** add fallback passthrough for unsupported subcommands ([614ff5c](https://github.com/Faire/rtk/commit/614ff5c13f526f537231aaa9fa098763822b4ee0))
* **python:** add lint dispatcher + universal format command ([#100](https://github.com/Faire/rtk/issues/100)) ([4cae6b6](https://github.com/Faire/rtk/commit/4cae6b6c9a4fbc91c56a99f640d217478b92e6d9))
* **read:** add stdin support via "-" path ([060c38b](https://github.com/Faire/rtk/commit/060c38b3c1ab29070c16c584ea29da3d5ca28f3d))
* rewrite engine, OpenCode support, hook system improvements ([#539](https://github.com/Faire/rtk/issues/539)) ([c1de10d](https://github.com/Faire/rtk/commit/c1de10d94c0a35f825b71713e2db4624310c03d1))
* rtk tree + fix rtk ls + full audit (phase 1-2-3) ([cb83da1](https://github.com/Faire/rtk/commit/cb83da104f7beba3035225858d7f6eb2979d950c))
* **security:** add SHA-256 hook integrity verification ([f2caca3](https://github.com/Faire/rtk/commit/f2caca3abc330fb45a466af6a837ed79c3b00b40))
* **security:** add SHA-256 hook integrity verification ([95677e9](https://github.com/Faire/rtk/commit/95677e978660d2ceb4c49b0c7835a4710dcdde97))
* shared infrastructure for new commands ([6c60888](https://github.com/Faire/rtk/commit/6c608880e9ecbb2b3569f875e7fad37d1184d751))
* shared infrastructure for new commands ([9dbc117](https://github.com/Faire/rtk/commit/9dbc1178e7f7fab8a0695b624ed3744ab1a8bf02))
* **sqlite:** add custom sqlite db location ([6e181ae](https://github.com/Faire/rtk/commit/6e181aec087edb50625e08b72fe7abdadbb6c72b))
* **sqlite:** add custom sqlite db location ([93364b5](https://github.com/Faire/rtk/commit/93364b5457619201c656fc2423763fea77633f15))
* tee raw output to file for LLM re-read without re-run ([#134](https://github.com/Faire/rtk/issues/134)) ([a08a62b](https://github.com/Faire/rtk/commit/a08a62b4e3b3c6a2ad933978b1143dcfc45cf891))
* TOML Part 1 — filter DSL engine + 14 built-in filters ([#349](https://github.com/Faire/rtk/issues/349)) ([adda253](https://github.com/Faire/rtk/commit/adda2537be1fe69625ac280f15e8c8067d08c711))
* TOML Part 2 — user-global config, shadow warning, rtk init templates, 4 new built-in filters ([#351](https://github.com/Faire/rtk/issues/351)) ([926e6a0](https://github.com/Faire/rtk/commit/926e6a0dd4512c4cbb0f5ac133e60cb6134a3174))
* TOML Part 3 — 15 additional built-in filters (ping, rsync, dotnet, swift, shellcheck, hadolint, poetry, composer, brew, df, ps, systemctl, yamllint, markdownlint, uv) ([#386](https://github.com/Faire/rtk/issues/386)) ([b71a8d2](https://github.com/Faire/rtk/commit/b71a8d24e2dbd3ff9bb423c849638bfa23830c0b))
* ultra-compact kubectl output (summary only, show issues) ([5ed6799](https://github.com/Faire/rtk/commit/5ed679911776d05e43b5650cf35380155e54e982))
* **vitest:** add module with ANSI stripping and test filtering ([62c9b19](https://github.com/Faire/rtk/commit/62c9b19689f70d99d6bffdc5576fcdd819a38f8a))
* warn when installed hook is outdated ([#344](https://github.com/Faire/rtk/issues/344)) ([#350](https://github.com/Faire/rtk/issues/350)) ([3141fec](https://github.com/Faire/rtk/commit/3141fecf958af5ae98c232543b913f3ca388254f))


### Bug Fixes

* 3 issues (latest tag, ccusage fallback, versioning) ([d773ec3](https://github.com/Faire/rtk/commit/d773ec3ea515441e6c62bbac829f45660cfaccde))
* 4 critical bugs + telemetry enrichment ([#462](https://github.com/Faire/rtk/issues/462)) ([7d76af8](https://github.com/Faire/rtk/commit/7d76af84b95e0f040e8b91a154edb89f80e5c380))
* 6 critical bugs — exit codes, unwrap, lazy regex ([#626](https://github.com/Faire/rtk/issues/626)) ([3005ebd](https://github.com/Faire/rtk/commit/3005ebd0ad07912ae919687f6d3d49482aabaeac))
* add security validation and error handling to pnpm ([f87be32](https://github.com/Faire/rtk/commit/f87be329b55b0e6a4cd242715ee8f42f75ce9e25))
* add tokens_saved to telemetry payload ([#471](https://github.com/Faire/rtk/issues/471)) ([#472](https://github.com/Faire/rtk/issues/472)) ([f8b7d52](https://github.com/Faire/rtk/commit/f8b7d52d2d25d09a44f391576bad6a7b271f1f8c))
* add website URL (rtk-ai.app) across project metadata ([#81](https://github.com/Faire/rtk/issues/81)) ([c84fa3c](https://github.com/Faire/rtk/commit/c84fa3c060c7acccaedb617852938c894f30f81e))
* address code review — hook_check edge cases ([ba50491](https://github.com/Faire/rtk/commit/ba50491cd615838c4f93455e94cdc32b7cb33d9b))
* align 7 TOML filter tests with on_empty behavior ([04ed6d8](https://github.com/Faire/rtk/commit/04ed6d8c314dcbf86b147903b5a7f1cd956dc980))
* align 7 TOML filter tests with on_empty behavior ([9a499b9](https://github.com/Faire/rtk/commit/9a499b9714e97a553d5603680ab1f843034acf28))
* allow git status to accept native flags ([a7ea143](https://github.com/Faire/rtk/commit/a7ea1439fb99a9bd02292068625bed6237f6be0c))
* allow git status to accept native flags ([a27bce8](https://github.com/Faire/rtk/commit/a27bce82f09701cb9df2ed958f682ab5ac8f954e))
* bugs [#196](https://github.com/Faire/rtk/issues/196) [#344](https://github.com/Faire/rtk/issues/344) [#345](https://github.com/Faire/rtk/issues/345) [#346](https://github.com/Faire/rtk/issues/346) [#347](https://github.com/Faire/rtk/issues/347) — gh --json, hook check, RTK_DISABLED, 2&gt;&1, json TOML ([8953af0](https://github.com/Faire/rtk/commit/8953af0fc06759b37f16743ef383af0a52af2bed))
* **cicd-docs:** add agent reviewer + some contribute guidelines ([de710f4](https://github.com/Faire/rtk/commit/de710f4ea30c333130c46f8a2e2c5b6b9edd4889))
* **cicd-docs:** some logs to understand what is happening when check docs ([191ea9a](https://github.com/Faire/rtk/commit/191ea9af9f99ee78d74385fe1952ce83045e4afe))
* **cicd:** Clean cicd, rework depends and add pre-release ([d24a765](https://github.com/Faire/rtk/commit/d24a7650e26aca89224a3ec5d263f1ce7c7121d6))
* **cicd:** Clean cicd, rework depends and add pre-release ([6303e95](https://github.com/Faire/rtk/commit/6303e9530a379a8e3939e6c122ab4cf07cb16751))
* **cicd:** clippy - do not treat warn as error ([5da5db2](https://github.com/Faire/rtk/commit/5da5db222d9927394995ccaeb3afc103e80c22bd))
* **ci:** correct rust-toolchain action name ([9526471](https://github.com/Faire/rtk/commit/9526471530b7d272f32aca38ace7548fd221547e))
* **ci:** fix release artifacts not uploading ([#73](https://github.com/Faire/rtk/issues/73)) ([bb20b1e](https://github.com/Faire/rtk/commit/bb20b1e9e1619e0d824eb0e0b87109f30bf4f513))
* **ci:** fix release workflow not uploading artifacts to GitHub releases ([bd76b36](https://github.com/Faire/rtk/commit/bd76b361908d10cce508aff6ac443340dcfbdd76))
* comprehensive code quality improvements ([5b840cc](https://github.com/Faire/rtk/commit/5b840cca492ea32488d8c80fd50d3802a0c41c72))
* convert rtk ls from reimplementation to native proxy ([fe4e0f9](https://github.com/Faire/rtk/commit/fe4e0f9976d10957ba3fbd7b221a4db5950a2f3b))
* convert rtk ls from reimplementation to native proxy ([2176369](https://github.com/Faire/rtk/commit/2176369467e00091dfd25f4fef57036e760842f2))
* correct install.sh URL (master not main) ([964601f](https://github.com/Faire/rtk/commit/964601f71018da81b027e2a7eb9ddbb4f09e5ee4))
* correct rust-toolchain action and macos runner ([2d40c7c](https://github.com/Faire/rtk/commit/2d40c7c02d3a79b746f7321aad43f1da9d0dd903))
* curl JSON size guard ([#297](https://github.com/Faire/rtk/issues/297)) + exclude_commands config ([#243](https://github.com/Faire/rtk/issues/243)) ([#342](https://github.com/Faire/rtk/issues/342)) ([a8d6106](https://github.com/Faire/rtk/commit/a8d6106f736e049013ecb77f0f413167266dd40e))
* detect and warn RTK_DISABLED=1 overuse ([#508](https://github.com/Faire/rtk/issues/508)) ([ae96e74](https://github.com/Faire/rtk/commit/ae96e74580884137611b0ce155940484d27d07ad))
* **discover:** add cargo check support, wire RtkStatus::Passthrough, enhance rtk init ([d5f8a94](https://github.com/Faire/rtk/commit/d5f8a9460421821861a32eedefc0800fb7720912))
* **docs:** escape HTML tags in rustdoc comments ([b13d92c](https://github.com/Faire/rtk/commit/b13d92c9ea83e28e97847e0a6da696053364bbfc))
* eliminate duplicate output when grep-ing function names from git show ([#248](https://github.com/Faire/rtk/issues/248)) ([a6f65f1](https://github.com/Faire/rtk/commit/a6f65f11da71936d148a2562216ab45b4c4b04a0))
* failing context for doc analyze -&gt; cat from files ([c6b7db2](https://github.com/Faire/rtk/commit/c6b7db2e5a6cd9a05262e934b4fc7a44c699c3b0))
* filter docker compose hook rewrites to supported subcommands ([#245](https://github.com/Faire/rtk/issues/245)) ([dbbf980](https://github.com/Faire/rtk/commit/dbbf980f3ba9a51d0f7eb703e7b3c52fde2b784f)), closes [#244](https://github.com/Faire/rtk/issues/244)
* **find:** accept native find flags (-name, -type, etc.) ([#211](https://github.com/Faire/rtk/issues/211)) ([7ac5bc4](https://github.com/Faire/rtk/commit/7ac5bc4bd3942841cc1abb53399025b4fcae10c9))
* **find:** rewrite with ignore crate + fix json stdin + benchmark pipeline ([fcc1462](https://github.com/Faire/rtk/commit/fcc14624f89a7aa9742de4e7bc7b126d6d030871))
* forward args in rtk git push/pull to support -u, remote, branch ([4bb0130](https://github.com/Faire/rtk/commit/4bb0130695ad2f5d91123afac2e3303e510b240c))
* gh pr edit/comment pass correct subcommand to gh ([#332](https://github.com/Faire/rtk/issues/332)) ([799f085](https://github.com/Faire/rtk/commit/799f0856e4547318230fe150a43f50ab82e1cf03))
* gh run view --job flag loses its value ([#416](https://github.com/Faire/rtk/issues/416)) ([#477](https://github.com/Faire/rtk/issues/477)) ([3f37f5a](https://github.com/Faire/rtk/commit/3f37f5a78f7d4faa2900455a57fee645cf0d651f))
* gh run view drops --log-failed, --log, --json flags ([#159](https://github.com/Faire/rtk/issues/159)) ([d196c2d](https://github.com/Faire/rtk/commit/d196c2d2df9b7a807e02ace557a4eea45cfee77d))
* git branch creation silently swallowed by list mode ([#194](https://github.com/Faire/rtk/issues/194)) ([88dc752](https://github.com/Faire/rtk/commit/88dc752220dc79dfa09b871065b28ae6ef907231))
* git log --oneline no longer silently truncated to 10 entries ([#461](https://github.com/Faire/rtk/issues/461)) ([#478](https://github.com/Faire/rtk/issues/478)) ([b2c2914](https://github.com/Faire/rtk/commit/b2c2914b90d87ffc05d0afe65fe3288ff5f05f4a))
* git log --oneline regression drops commits ([#619](https://github.com/Faire/rtk/issues/619)) ([8e85d67](https://github.com/Faire/rtk/commit/8e85d676d78b12d2c421bb892f93971fc222fb39))
* **git:** accept native git flags in add command (including -A) ([2ade8fe](https://github.com/Faire/rtk/commit/2ade8fe030d8b1bc2fa294aa710ed1f5f877136f))
* **git:** accept native git flags in add command (including -A) ([40e7ead](https://github.com/Faire/rtk/commit/40e7eadbaf0b89a54b63bea73014eac7cf9afb05))
* **git:** fix for issue [#82](https://github.com/Faire/rtk/issues/82) ([04e6bb0](https://github.com/Faire/rtk/commit/04e6bb032ccd67b51fb69e326e27eff66c934043))
* **git:** propagate exit codes in push/pull/fetch/stash/worktree ([#234](https://github.com/Faire/rtk/issues/234)) ([5cfaecc](https://github.com/Faire/rtk/commit/5cfaeccaba2fc6e1fe5284f57b7af7ec7c0a224d))
* **git:** Returns "Not a git repository" when git status is executed in a non-repo folder [#82](https://github.com/Faire/rtk/issues/82) ([d4cb2c0](https://github.com/Faire/rtk/commit/d4cb2c08100d04755fa776ec8000c0b9673e4370))
* **git:** support multiple -m flags in git commit ([292225f](https://github.com/Faire/rtk/commit/292225f2dd09bfc5274cc8b4ed92d1a519929629))
* **git:** support multiple -m flags in git commit ([c18553a](https://github.com/Faire/rtk/commit/c18553a55c1192610525a5341a183da46c59d50c))
* **gradle:** deduplicate --console plain when user passes it explicitly ([#43](https://github.com/Faire/rtk/issues/43)) ([9a05d4a](https://github.com/Faire/rtk/commit/9a05d4ad3198ca55ad2d628d0ead13bd8e949469))
* **gradle:** filter stderr through global noise patterns ([#13](https://github.com/Faire/rtk/issues/13)) ([b61d18d](https://github.com/Faire/rtk/commit/b61d18db05bc21f1a1e2be157d3062846badab01))
* **gradle:** strip --quiet/-q to ensure parseable output ([#17](https://github.com/Faire/rtk/issues/17)) ([72ae1a1](https://github.com/Faire/rtk/commit/72ae1a19d156a3db370f75818d8f3bd921b82066))
* **grep:** accept -n flag for grep/rg compatibility ([7d561cc](https://github.com/Faire/rtk/commit/7d561cca51e4e177d353e6514a618e5bb09eebc6))
* **grep:** accept -n flag for grep/rg compatibility ([7d69299](https://github.com/Faire/rtk/commit/7d69299c9f0bd3b3df6dc0c46f00a94f65fe3cfa))
* **grep:** translate BRE \| alternation and strip -r flag for rg ([#206](https://github.com/Faire/rtk/issues/206)) ([70d1b04](https://github.com/Faire/rtk/commit/70d1b04093a3dfcc99991502f1530cbb13bae872))
* handle -n N and --max-count=N forms in git log limit parsing ([e67f52c](https://github.com/Faire/rtk/commit/e67f52ce48be57ce38bbcfe0e232758fb201893a))
* handle tail rewrites with read tail-lines ([a314927](https://github.com/Faire/rtk/commit/a314927051e76b2334abbad0b834329faa2b45c5))
* handle tail rewrites with read tail-lines ([02502d1](https://github.com/Faire/rtk/commit/02502d1366b61438ffbdbe52b235cb81b25fe3f8))
* **hook:** use POSIX character classes for cross-platform grep compatibility ([#98](https://github.com/Faire/rtk/issues/98)) ([4aafc83](https://github.com/Faire/rtk/commit/4aafc832d4bdd438609358e2737a96bee4bb2467))
* improve adoption metric by detecting hook-rewritten commands ([eb8a2c4](https://github.com/Faire/rtk/commit/eb8a2c4a71072870fca4b64e90189a4453acff84))
* improve CI reliability and hook coverage ([#95](https://github.com/Faire/rtk/issues/95)) ([50bb494](https://github.com/Faire/rtk/commit/50bb4943f73d8bf9c615155485f7efed802e64d6))
* improve CI reliability and hook coverage ([#95](https://github.com/Faire/rtk/issues/95)) ([ac80bfa](https://github.com/Faire/rtk/commit/ac80bfa88f91dfaf562cdd786ecd3048c554e4f7))
* improve command robustness and flag support ([c2cd691](https://github.com/Faire/rtk/commit/c2cd691c823c8b1dd20d50d01486664f7fd7bd28))
* improve command robustness and flag support ([d7d8c65](https://github.com/Faire/rtk/commit/d7d8c65b86d44792e30ce3d0aff9d90af0dd49ed))
* improve error handling and merge commit detection ([d3b7301](https://github.com/Faire/rtk/commit/d3b7301e21a1fbb8aff91306e66e274ee2a7c5c7))
* install to ~/.local/bin instead of /usr/local/bin (closes [#155](https://github.com/Faire/rtk/issues/155)) ([#161](https://github.com/Faire/rtk/issues/161)) ([0b34772](https://github.com/Faire/rtk/commit/0b34772a679f3c6b5dd9609af2f6eec6d79e4a64))
* **integrity:** address security review findings ([1d7d9d0](https://github.com/Faire/rtk/commit/1d7d9d065ecf1b045300a67648bac5940e1356b8))
* **ls:** compact output (-72% tokens) + fix discover panic ([ea7cdb7](https://github.com/Faire/rtk/commit/ea7cdb7a3b622f62e0a085144a637a22108ffdb7))
* normalize binlogs CRLF ([5344af9](https://github.com/Faire/rtk/commit/5344af9a51f06b5dc42692e42c948ff11a3173c6))
* npm routing, discover cat redirect, proxy quoted args ([#480](https://github.com/Faire/rtk/issues/480)) ([a2e07a5](https://github.com/Faire/rtk/commit/a2e07a5c8bc6dddd3429b28ab885bd1a39b93d61))
* only rewrite docker compose ps/logs/build, skip unsupported subcommands ([#336](https://github.com/Faire/rtk/issues/336)) ([#363](https://github.com/Faire/rtk/issues/363)) ([dbc9503](https://github.com/Faire/rtk/commit/dbc950395e31b4b0bc48710dc52ad01d4d73f9ba))
* optimize HashMap merge and add safety checks ([3b847f8](https://github.com/Faire/rtk/commit/3b847f863a90b2e9a9b7eb570f700a376bce8b22))
* P0 crashes + cargo check + dedup utilities + discover status ([05078ff](https://github.com/Faire/rtk/commit/05078ff2dab0c8745b9fb44b1d462c0d32ae8d77))
* P0 crashes + cargo check + dedup utilities + discover status ([60d2d25](https://github.com/Faire/rtk/commit/60d2d252efbedaebae750b3122385b2377ab01eb))
* pass git flags transparently to git command ([93f9fbe](https://github.com/Faire/rtk/commit/93f9fbedb4eb485989bc9a59a17bc5ff5bf9aac7))
* pass through -R/--repo flag in gh view commands ([#328](https://github.com/Faire/rtk/issues/328)) ([0a1bcb0](https://github.com/Faire/rtk/commit/0a1bcb05e5737311211369dcb92b3f756a6230c6)), closes [#223](https://github.com/Faire/rtk/issues/223)
* patrick's 3 issues (latest tag, ccusage fallback, versioning) ([9e322e2](https://github.com/Faire/rtk/commit/9e322e2aee9f7239cf04ce1bf9971920035ac4bb))
* **playwright:** fix JSON parser and binary resolution ([#215](https://github.com/Faire/rtk/issues/215)) ([461856c](https://github.com/Faire/rtk/commit/461856c8fd78cce8e2d875ae878111d7cb3610cd))
* **playwright:** fix JSON parser to match real Playwright output format ([#193](https://github.com/Faire/rtk/issues/193)) ([4eb6cf4](https://github.com/Faire/rtk/commit/4eb6cf4b1a2333cb710970e40a96f1004d4ab0fa))
* preserve -- separator for cargo commands and silence fallback ([#326](https://github.com/Faire/rtk/issues/326)) ([45f9344](https://github.com/Faire/rtk/commit/45f9344f033d27bc370ff54c4fc0c61e52446076)), closes [#286](https://github.com/Faire/rtk/issues/286) [#287](https://github.com/Faire/rtk/issues/287)
* preserve commit body in git log output ([e189bbb](https://github.com/Faire/rtk/commit/e189bbbe749120eda4d98a2130937269d8c0e92a))
* preserve first line of commit body in git log output ([c3416eb](https://github.com/Faire/rtk/commit/c3416eb45f2f97297ec149d296a6a500697d302b))
* preserve trailing newline in tail_lines + add missing test ([1448914](https://github.com/Faire/rtk/commit/144891472a186df79585924ab599744cc3ad87f8))
* prettier false positive when not installed ([#221](https://github.com/Faire/rtk/issues/221)) ([#359](https://github.com/Faire/rtk/issues/359)) ([85b0b3e](https://github.com/Faire/rtk/commit/85b0b3eb0bad9cbacdc32d2e9ba525728acd7cbe))
* prevent UTF-8 panics on multi-byte characters ([#93](https://github.com/Faire/rtk/issues/93)) ([155e264](https://github.com/Faire/rtk/commit/155e26423d1fe2acbaed3dc1aab8c365324d53e0))
* propagate linter exit code in rtk lint ([#207](https://github.com/Faire/rtk/issues/207)) ([8e826fc](https://github.com/Faire/rtk/commit/8e826fc89fe7350df82ee2b1bae8104da609f2b2)), closes [#185](https://github.com/Faire/rtk/issues/185)
* propagate rg exit code in rtk grep for CLI parity ([#227](https://github.com/Faire/rtk/issues/227)) ([f1be885](https://github.com/Faire/rtk/commit/f1be88565e602d3b6777f629d417e957a62daae2)), closes [#162](https://github.com/Faire/rtk/issues/162)
* reduce gh diff / git diff / gh api truncation ([#354](https://github.com/Faire/rtk/issues/354)) ([#370](https://github.com/Faire/rtk/issues/370)) ([e356c12](https://github.com/Faire/rtk/commit/e356c1280da9896195d0dff91e152c5f20347a65))
* **registry:** "fi" in IGNORED_PREFIXES shadows find commands ([#246](https://github.com/Faire/rtk/issues/246)) ([48965c8](https://github.com/Faire/rtk/commit/48965c85d2dd274bbdcf27b11850ccd38909e6f4))
* release pipeline trigger and version-agnostic package URLs ([108d0b5](https://github.com/Faire/rtk/commit/108d0b5ea316ab33c6998fb57b2caf8c65ebe3ef))
* release pipeline trigger and version-agnostic package URLs ([264539c](https://github.com/Faire/rtk/commit/264539cf20a29de0d9a1a39029c04cb8eb1b8f10))
* remove personal preferences from project CLAUDE.md ([3a8044e](https://github.com/Faire/rtk/commit/3a8044ef6991b2208d904b7401975fcfcb165cdb))
* remove personal preferences from project CLAUDE.md ([d362ad0](https://github.com/Faire/rtk/commit/d362ad0e4968cfc6aa93f9ef163512a692ca5d1b))
* remove remaining personal project reference from CLAUDE.md ([5b59700](https://github.com/Faire/rtk/commit/5b597002dcd99029cb9c0da9b6d38b44021bdb3a))
* remove remaining personal project reference from CLAUDE.md ([dc09265](https://github.com/Faire/rtk/commit/dc092655fb84a7c19a477e731eed87df5ad0b89f))
* remove version check from validate-docs CI ([#476](https://github.com/Faire/rtk/issues/476)) ([#543](https://github.com/Faire/rtk/issues/543)) ([6e61c24](https://github.com/Faire/rtk/commit/6e61c2447cc03af94220ce6ce83686f155e18086))
* resolve Windows command wrapper execution ([#269](https://github.com/Faire/rtk/issues/269)) ([2e194ef](https://github.com/Faire/rtk/commit/2e194efb3ac5e4cba51e13ec64d3f09196f772cf))
* respect user-specified git log limits ([#461](https://github.com/Faire/rtk/issues/461)) ([e06d77e](https://github.com/Faire/rtk/commit/e06d77ec92eba19074ff7b3a512067924ca763f2))
* respect user-specified git log limits instead of silently truncating ([07901c8](https://github.com/Faire/rtk/commit/07901c8249be03145c3495c4cb9969be80f8aad5)), closes [#461](https://github.com/Faire/rtk/issues/461)
* restore lost telemetry install_method enrichment ([#469](https://github.com/Faire/rtk/issues/469)) ([0c5cde9](https://github.com/Faire/rtk/commit/0c5cde9ec234a2b7b0376adbcb78f2be48a98e86))
* review iteration 2 — double-warning, case-sensitive test, ssh truncate ([7921e96](https://github.com/Faire/rtk/commit/7921e96dae7147c18f8e25437d61111700bc0224))
* rtk read no longer corrupts JSON files with glob patterns ([#464](https://github.com/Faire/rtk/issues/464)) ([#479](https://github.com/Faire/rtk/issues/479)) ([18f4401](https://github.com/Faire/rtk/commit/18f4401a939e5d64e3a658c9f9ee27b25e2de45c))
* rtk rewrite accepts multiple args without quotes ([#504](https://github.com/Faire/rtk/issues/504)) ([cb79b4c](https://github.com/Faire/rtk/commit/cb79b4c701cd29a3b84e21827250c9220b726e88))
* RTK_DISABLED ignored, 2&gt;&1 broken, json TOML error ([#345](https://github.com/Faire/rtk/issues/345), [#346](https://github.com/Faire/rtk/issues/346), [#347](https://github.com/Faire/rtk/issues/347)) ([6c13d23](https://github.com/Faire/rtk/commit/6c13d234364d314f53b6698c282a621019635fd6))
* show full error output on git command failures ([1f1576a](https://github.com/Faire/rtk/commit/1f1576a6576f74209d8042fe3c81b040c4efe875))
* skip rewrite for gh --json/--jq/--template ([#196](https://github.com/Faire/rtk/issues/196)) ([079ee9a](https://github.com/Faire/rtk/commit/079ee9a4ea868ecf4e7beffcbc681ca1ba8b165c))
* smart markdown body filter for gh issue/pr view ([#188](https://github.com/Faire/rtk/issues/188)) ([#214](https://github.com/Faire/rtk/issues/214)) ([4208015](https://github.com/Faire/rtk/commit/4208015cce757654c150f3d71ddd004d22b4dd25))
* split chained commands in adoption metric ([127f85c](https://github.com/Faire/rtk/commit/127f85c02efd52a64e461005fa142d05f81615f8))
* strip npx/bunx/pnpm prefixes in lint linter detection ([#186](https://github.com/Faire/rtk/issues/186)) ([#366](https://github.com/Faire/rtk/issues/366)) ([27b35d8](https://github.com/Faire/rtk/commit/27b35d84a341622aa4bf686c2ce8867f8feeb742))
* support additional git global options (--no-pager, --no-optional-locks, --bare, --literal-pathspecs) ([68ca712](https://github.com/Faire/rtk/commit/68ca7126d45609a41dbff95e2770d58a11ebc0a3))
* support git -C &lt;path&gt; in rewrite registry ([c916bab](https://github.com/Faire/rtk/commit/c916bab33ae9760b234fd720c944a849141f0d2e)), closes [#555](https://github.com/Faire/rtk/issues/555)
* support git commit -am, --amend and other flags ([#327](https://github.com/Faire/rtk/issues/327)) ([#360](https://github.com/Faire/rtk/issues/360)) ([409aed6](https://github.com/Faire/rtk/commit/409aed6dbcdd7cac2a48ec5655e6f1fd8d5248e3))
* support git global options (-C, -c, --git-dir, --work-tree, --no-pager, --no-optional-locks, --bare, --literal-pathspecs) ([a6ccefe](https://github.com/Faire/rtk/commit/a6ccefe8e71372b61e6e556f0d36a944d1bcbd70))
* support git global options (-C, -c, --git-dir, --work-tree) ([982084e](https://github.com/Faire/rtk/commit/982084ee34c17d2fe89ff9f4839374bf0caa2d19))
* surface build failures in go test summary ([#274](https://github.com/Faire/rtk/issues/274)) ([b405e48](https://github.com/Faire/rtk/commit/b405e48ca6c4be3ba702a5d9092fa4da4dff51dc))
* test-all.sh aborts when gt not installed ([#500](https://github.com/Faire/rtk/issues/500)) ([#544](https://github.com/Faire/rtk/issues/544)) ([26f5473](https://github.com/Faire/rtk/commit/26f547371798ad32aed3569965303bc4857789ed))
* trigger release build after release-please creates tag ([3ddffdd](https://github.com/Faire/rtk/commit/3ddffddc6dc34dacbf5f9dd32dd71bacaa8b0881))
* trigger release build after release-please creates tag ([3b44ef9](https://github.com/Faire/rtk/commit/3b44ef98651906ccc44cdaa77c5434c3f033f462))
* trust boundary followup — TOML key typo + missing meta commands ([#625](https://github.com/Faire/rtk/issues/625)) ([8d8e188](https://github.com/Faire/rtk/commit/8d8e188705e5784829693a83b2076d6118154764))
* **tsc:** show every TypeScript error instead of collapsing by code ([3df8ce5](https://github.com/Faire/rtk/commit/3df8ce552585d8d0a36f9c938d381ac0bc07b220))
* **tsc:** show every TypeScript error instead of collapsing by code ([67e8de8](https://github.com/Faire/rtk/commit/67e8de8732363d111583e5b514d05e092355b97e))
* update ARCHITECTURE.md version to 0.18.0 ([398cb08](https://github.com/Faire/rtk/commit/398cb08125410a4de11162720cf3499d3c76f12d))
* update CLAUDE.md version to 0.18.1 ([34db3e4](https://github.com/Faire/rtk/commit/34db3e47382a5857cbe5c8fc0421bb4ed3a0be9e))
* update README.md version to 0.18.1 ([621b65a](https://github.com/Faire/rtk/commit/621b65afea8a728d490be45972f93ff0185f0505))
* update stale repo URLs from pszymkowiak/rtk to rtk-ai/rtk ([#78](https://github.com/Faire/rtk/issues/78)) ([55d010a](https://github.com/Faire/rtk/commit/55d010ad5eced14f525e659f9f35d051644a1246))
* update version references to 0.16.0 in README.md and CLAUDE.md ([ec54833](https://github.com/Faire/rtk/commit/ec54833621c8ca666735e1a08ed5583624b250c1))
* update version references to 0.18.0 in docs ([c73ed47](https://github.com/Faire/rtk/commit/c73ed470a79ab9e4771d2ad65394859e672b4123))
* update version refs to 0.23.0, module count to 51, fmt upstream files ([eed0188](https://github.com/Faire/rtk/commit/eed018814b141ada8140f350adc26d9f104cf368))
* upstream alignment for gradle PR readiness ([#22](https://github.com/Faire/rtk/issues/22)) ([da202d1](https://github.com/Faire/rtk/commit/da202d19e56ad84e1b40599008b84f98cfac5675))
* use rtk &lt;cmd&gt; instead of rtk proxy for TOML-filtered commands ([#507](https://github.com/Faire/rtk/issues/507)) ([e9eb152](https://github.com/Faire/rtk/commit/e9eb152c21e25762cecfbda6be2317d3e3e1def8))
* **vitest:** improve parser to handle real Vitest output format ([fc1ed38](https://github.com/Faire/rtk/commit/fc1ed38f40e766d59d43325549b3e0c8b2944f21))
* **vitest:** robust JSON extraction for pnpm/dotenv prefixes ([#92](https://github.com/Faire/rtk/issues/92)) ([ab43e4b](https://github.com/Faire/rtk/commit/ab43e4b8231d977e561a963b2218b122a57183b7))
* **vitest:** robust JSON extraction for pnpm/dotenv prefixes ([#92](https://github.com/Faire/rtk/issues/92)) ([e5adba8](https://github.com/Faire/rtk/commit/e5adba8b214a6609cf1a2cda05f21bcf2a1adb94))
* warn when no hook installed + rtk gain hook status + PR [#499](https://github.com/Faire/rtk/issues/499) fixes ([22deca1](https://github.com/Faire/rtk/commit/22deca14ad393acbe6a0ec45f47d853c1339b87e))
* windows path fix for git tests ([0a904e2](https://github.com/Faire/rtk/commit/0a904e264d58f8f4b5f10e37ec3b11f717458fe0))
